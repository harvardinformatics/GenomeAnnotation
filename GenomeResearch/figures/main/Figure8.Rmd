...
utrratio_toblastxfrac_plot <- data4sp %>% ggplot() + 
      geom_point(mapping=aes(y=PcentTscriptsUtrBlastx,x=PredUtrCdsRatio/RefMedianUtrCdsRatio,color=method,shape=species),size=2.2) +
  ...
  geom_text(x=1.9,y=35,label=expression(paste("Pearson's ",rho,"=0.68, p=0.0010")),size=3.2)
