...
subtitle: "Figure 3: CDS intergenic gene rates"
date: "April 10, 2024"
...
## Figure 3
```{r}
intergenic_plot <- data %>% ggplot(aes(x=species,y=intergenic_genes/protcod_genes)) + geom_point(aes(fill=method),color="black",pch=21,position = position_jitter(w = 0.25,h = 0),alpha=0.7,size=1.75) +
...
ggsave(intergenic_plot,file="Figure3.pdf",width=7,height=5)
```
