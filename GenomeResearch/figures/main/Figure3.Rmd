...
subtitle: "Figure 3: protein-coding intergenic gene rate (relative to NCBI): 
...
## Figure 3
```{r}
intergenic_plot <- annotations %>% filter(group!="heliconines") %>% ggplot(aes(x=species,y=intergenic_genes/pcodgenes_wCDS)) + geom_point(aes(fill=method),color="black",pch=21,position = position_jitter(w = 0.33,h = 0),alpha=0.7,size=2.8) +
...
ylab("Proportion genes intergenic") +
xlab("") + 
geom_vline(xintercept=1.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=2.5,linetype="dotted",size=0.5)+
geom_vline(xintercept=3.5,linetype="solid",size=1) +
geom_vline(xintercept=4.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=5.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=6.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=7.5,linetype="solid",size=1)+
geom_vline(xintercept=8.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=9.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=10.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=11.5,linetype="solid",size=1)+
geom_vline(xintercept=12.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=13.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=14.5,linetype="solid",size=1) +
geom_vline(xintercept=15.5,linetype="dotted",size=0.5) +
geom_vline(xintercept=16.5,linetype="dotted",size=0.5) +
...
ggsave(intergenic_plot,file="Figure3.pdf",width=8,height=5.5)
```
