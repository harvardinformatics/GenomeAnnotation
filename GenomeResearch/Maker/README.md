...
We run it using [maker-snap-training.sh](https://github.com/harvardinformatics/GenomeAnnotation/blob/master/GenomeResearch/Maker/slurm_scripts/maker-snap-training.sh):
...
This command is wrapped in [BUSCO-augustus-training-butterflies.sh](https://github.com/harvardinformatics/GenomeAnnotation/blob/master/GenomeResearch/Maker/slurm_scripts/maker-snap-training.sh) and can be executed as follows:
