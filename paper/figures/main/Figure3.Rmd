...
## Figure 3
```{r}
intergenic_plot <- data %>% ggplot(aes(x=species,y=intergenic_genes/protcod_genes)) + geom_point(aes(color=method),position = position_jitter(w = 0.25,h = 0),alpha=0.7,size=1.75) +
