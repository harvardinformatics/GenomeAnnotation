...
```{r}
blastphit_plot <- data %>% ggplot(aes(x=species,y=100*blastp2NCBIfraction)) + geom_point(aes(color=method),position = position_jitter(w = 0.18,h = 0),alpha=0.7,size=2.5) +
...
ggsave(blastphit_plot,file="Figure_6A.pdf",width=7,height=5)
```
