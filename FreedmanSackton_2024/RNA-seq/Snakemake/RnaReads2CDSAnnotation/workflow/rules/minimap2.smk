rule minimap2_index:
    ...
    output:
       config["Minimap2IndexDir"] + config["speciesname"] + "_" + config["minimap2_index_datatype"] + ".mmi" 
    conda:
        "../envs/minimap2.yml"
    resources:
    ...
    params:
        ...
        datatype_params =  config["minimap2_datatype2params"][config["minimap2_index_datatype"]]
    shell:
        "minimap2 -d {params.indexdir}{output} -x {params.datatype_params} {input.genome_fasta}"
...
rule minimap2_align:
    ...
    resources:
        ...
        time =  res_config["minimap2_align"]["time"]
    params:
